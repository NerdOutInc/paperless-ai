...
OUT="videos/06-install-raspberry-pi-build/renders/06-install-raspberry-pi-rev5-preview.mp4"
...
[0:v]trim=start=81.45:end=81.466667,setpts=PTS-STARTPTS,scale=1280:768:flags=lanczos,fps=60,format=yuv420p,tpad=stop_mode=clone:stop_duration=13.983333[b16];
[0:v]trim=start=81.45:end=82,setpts=PTS-STARTPTS,scale=1280:768:flags=lanczos,fps=60,format=yuv420p[b17];
[0:v]trim=start=82:end=82.016667,setpts=PTS-STARTPTS,scale=1280:768:flags=lanczos,fps=60,format=yuv420p,tpad=stop_mode=clone:stop_duration=7.433333[b18];
...
[0:v]trim=start=85:end=99.65,setpts=(PTS-STARTPTS)*0.614334471,scale=1280:768:flags=lanczos,fps=60,format=yuv420p[b21];
[0:v]trim=start=99.65:end=99.666667,setpts=PTS-STARTPTS,scale=1280:768:flags=lanczos,fps=60,format=yuv420p,tpad=stop_mode=clone:stop_duration=10.983333[b22];
[0:v]trim=start=99.65:end=110.35,setpts=(PTS-STARTPTS)*0.2803738318,scale=1280:768:flags=lanczos,fps=60,format=yuv420p[b23];
[0:v]trim=start=110.35:end=121.5,setpts=(PTS-STARTPTS)*2.0322869955,scale=1280:768:flags=lanczos,fps=60,format=yuv420p[b24];
[0:v]trim=start=121.5:end=132,setpts=PTS-STARTPTS,scale=1280:768:flags=lanczos,fps=60,format=yuv420p,tpad=stop_mode=clone:stop_duration=16.66[b25];
[0:v]trim=start=132:end=132.5,setpts=PTS-STARTPTS,scale=1280:768:flags=lanczos,fps=60,format=yuv420p,tpad=stop_mode=clone:stop_duration=6.96[b26];
[0:v]trim=start=132.5:end=136,setpts=PTS-STARTPTS,scale=1280:768:flags=lanczos,fps=60,format=yuv420p[b27a];
[0:v]trim=start=136:end=136.016667,setpts=PTS-STARTPTS,scale=1280:768:flags=lanczos,fps=60,format=yuv420p,tpad=stop_mode=clone:stop_duration=3.203333[b27b];
[0:v]trim=start=136:end=145,setpts=PTS-STARTPTS,scale=1280:768:flags=lanczos,fps=60,format=yuv420p[b28a];
[3:v]trim=start=0:end=12,setpts=PTS-STARTPTS,scale=1280:768:flags=lanczos,fps=60,format=yuv420p[b28b];
[0:v]trim=start=145:end=152,setpts=PTS-STARTPTS,scale=1280:768:flags=lanczos,fps=60,format=yuv420p[b28c1];
[0:v]trim=start=152:end=152.016667,setpts=PTS-STARTPTS,scale=1280:768:flags=lanczos,fps=60,format=yuv420p,tpad=stop_mode=clone:stop_duration=8.983333[b28h];
[0:v]trim=start=152:end=164,setpts=PTS-STARTPTS,scale=1280:768:flags=lanczos,fps=60,format=yuv420p[b28c2];
[0:v]trim=start=164:end=164.016667,setpts=PTS-STARTPTS,scale=1280:768:flags=lanczos,fps=60,format=yuv420p,tpad=stop_mode=clone:stop_duration=16.983333[b31];
[0:v]trim=start=164:end=168,setpts=PTS-STARTPTS,scale=1280:768:flags=lanczos,fps=60,format=yuv420p[b32];
[0:v]trim=start=168:end=180,setpts=(PTS-STARTPTS)*1.4166666667,scale=1280:768:flags=lanczos,fps=60,format=yuv420p[b34];
[0:v]trim=start=180:end=180.016667,setpts=PTS-STARTPTS,scale=1280:768:flags=lanczos,fps=60,format=yuv420p,tpad=stop_mode=clone:stop_duration=13.983333[b35];
[4:v]trim=start=0.5:end=16.5,setpts=PTS-STARTPTS,scale=1280:768:flags=lanczos,fps=60,format=yuv420p[b35r];
[0:v]trim=start=181.5:end=184.216667,setpts=PTS-STARTPTS,scale=1280:768:flags=lanczos,fps=60,format=yuv420p[b36];
